...
| 8b    | ESP-01 AT layer: non-blocking AT state machine. *Note: ESP-01 hardware disconnected due to 5V logic mismatch; firmware handles timeouts gracefully.*                                                                                            | ✅        |
| 8c    | TMP35 analog temperature sensor integration: ADC HAL (`hal/adc`), TMP35 driver (10mV/°C conversion), and OLED display logic.                                                                                                                    | ✅        |
| 8d    | MCP3201 12-bit SPI ADC integration: hardware SPI HAL, MCP3201 driver, Chip Select on PC2, and display values on the OLED.                                                                                                                       | ✅        |
